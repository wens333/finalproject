...
export default function ProfileActivityDetailScreen(props) {
    // 資料庫
    useEffect(() => {
        initializeFirestore()
    }, [])
        ...
        <View style={styles.container}>
            <KeyboardAwareScrollView style={{ width: '100%' }}>
                ...
                <View image>
                    ...
                    <Image source={{ uri: passProps.smallimage }} style={{ width: '100%', height: 250 }} />
                </View>
                ...
                <View style={styles.containerInner}>
                    ...
                    <View style={styles.textContent}>
                        ...
                        <Text style={{ fontSize: 18 }}>{passProps.info}
                        </Text>
                    </View>
